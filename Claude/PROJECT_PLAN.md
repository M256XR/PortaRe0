...
> **⚠️ このファイルは初期計画書（凍結）です。**
> 仕様変更・最新の決定事項は **Claude.md** および **PROGRESS.md** を参照してください。
> このファイルは経緯確認用として保存しており、内容は session04 時点のままです。
...
- キースイッチ：Alps SKRPABE010（SMD タクタイル 4.2×3.2mm）× 63キー（C115360）
...
| アナログスティック最終選定 | **3DSスライドパッド確定** | FPCコネクタ C3170007（Molex 5034800440）/ VCC=3.3V直結確定 |
